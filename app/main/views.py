...
def pitches(category):
    ...
    return render_template("pitch.html", pitches=pitches, category=category)
...
def comments(pitch_id):
    ...
    comments = Comment.query.filter_by(pitch_id=pitch.id).order_by(
        Comment.posted.desc()
    )
...
def dislike(pitch_id):
    ...
    return render_template(
        "comments.html", pitch=pitch, comments=comments, dislike=dislike
    )
